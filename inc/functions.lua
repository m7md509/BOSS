...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "تذكار"
...
message = message ..k.. '-l ['..info.username..'](t.me/t7tedkar) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/t7tedkar) l » (`' ..v.. '`) \n'
end
end
end
