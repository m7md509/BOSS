...
return '- اصدار سورس تذكار : *v'..version..'* '
end
...
sendMsg(arg.chat_id_,arg.id_,'- عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس تذكار يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
if MsgText[1] == "." or MsgText[1]=="المطور" then
return [[
Welcome  
...
- [مطور البوت](https://t.me/t7tedkar)
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حماية تذكار ") end
...
elseif Text== "تف" then return sendMsg(msg.chat_id_,msg.id_,"اتـفــل اقـوا.")
elseif Text== "شلونكم" or Text== "شلونك" or Text== "اخباركم" or Text== "شونك" or Text== "شونكم" then 
return sendMsg(msg.chat_id_,msg.id_,"تـمـام قـلـبي 💙+ انـت شـلـونـك شـخـبـارك؟")
elseif Text== "طاط"  then return sendMsg(msg.chat_id_,msg.id_," يويلمهاالحبه الكبيره")
elseif Text== "وينك"  then return sendMsg(msg.chat_id_,msg.id_,"جنبك ي حلو")
elseif Text== "منورين"  then return sendMsg(msg.chat_id_,msg.id_,"بنورك")
elseif Text== "هاي"  then return sendMsg(msg.chat_id_,msg.id_,"اطلق هاي")
elseif Text== "🙊"  then return sendMsg(msg.chat_id_,msg.id_,"ابــوس الخـجـلان")
elseif Text== "😢"  then return sendMsg(msg.chat_id_,msg.id_,"لا تبكي")
elseif Text== "😭"  then return sendMsg(msg.chat_id_,msg.id_,"لا تبكي ")
elseif Text== "منور"  then return sendMsg(msg.chat_id_,msg.id_,"نــورك ♥️.")
elseif Text== "😒" and not is_sudo then return sendMsg(msg.chat_id_,msg.id_,"شفيك")
elseif Text== "مح"  then return sendMsg(msg.chat_id_,msg.id_,"اوفف عـسـل ") 
elseif Text== "شكرا" or Text== "ثكرا" then return  sendMsg(msg.chat_id_,msg.id_,"العفو ي روح قلبي")
elseif Text== "وينك"  then return sendMsg(msg.chat_id_,msg.id_,"بقلبك")
elseif Text== "اكرهك"  then return sendMsg(msg.chat_id_,msg.id_,"لا بموت اذا م حبيتني")
elseif Text== "اريد اكبل" then return sendMsg(msg.chat_id_,msg.id_,"بـطـران 🥲😂.")
elseif Text== "تذكار"  then return sendMsg(msg.chat_id_,msg.id_,"ياروح وقلب تذكار")
...
elseif Text== "كلخرا" then return sendMsg(msg.chat_id_,msg.id_,"خرا بحلقك")
elseif Text== "حبيبتي" then return sendMsg(msg.chat_id_,msg.id_,"يعععع")
elseif Text== "حروح اسبح" then return sendMsg(msg.chat_id_,msg.id_,"اجـي اسـبحـكك😔😂.")
elseif Text== "😔"  then return sendMsg(msg.chat_id_,msg.id_,"يعمري عليك")
elseif Text== "☹️"  then return sendMsg(msg.chat_id_,msg.id_,"يمه")
elseif Text== "جوعان"  then return sendMsg(msg.chat_id_,msg.id_,"نناكل سوا؟")
elseif Text== "لتحجي"  then return sendMsg(msg.chat_id_,msg.id_,"ونـت شـعلـيك حـاجـي بـحـلــكك 😉🤣")
elseif Text== "معليك" or Text== "شعليك" then return sendMsg(msg.chat_id_,msg.id_,"بكيفي اصلا")
...
elseif Text== "زاحف"  then return sendMsg(msg.chat_id_,msg.id_,"هههههههه كلتراب")
...
elseif Text== "مات"  then return sendMsg(msg.chat_id_,msg.id_,"الله يرحمه مسكين")
elseif Text== "ورده" or Text== "وردة" then return sendMsg(msg.chat_id_,msg.id_,"عـطـرها 💕.")
elseif Text== "شسمك"  then return sendMsg(msg.chat_id_,msg.id_,"ماااع")
...
elseif Text== "حبيبي" or Text=="حبي" then return  sendMsg(msg.chat_id_,msg.id_,"يلبى")
elseif Text== "حبيبتي" then return sendMsg(msg.chat_id_,msg.id_,"يلبى")
elseif Text== "حياتي" then return sendMsg(msg.chat_id_,msg.id_,"عافيتي")
elseif Text== "عمري" then return sendMsg(msg.chat_id_,msg.id_,"احب عمرك")
elseif Text== "اسكت" then return sendMsg(msg.chat_id_,msg.id_,"كلتراب م راح اسكت")
elseif Text== "بتحبني" then return sendMsg(msg.chat_id_,msg.id_,"لا يعععععع")
elseif Text== "موجود" then return sendMsg(msg.chat_id_,msg.id_,"اكييييد موجود افا عليك ")
elseif Text== "اقلك" then return sendMsg(msg.chat_id_,msg.id_,"قول جعل م يقول غيرك")
